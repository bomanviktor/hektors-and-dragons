...
const LoreScreen = ({ handler }: { handler: () => void }) => {
  return (
    <div className="flex flex-col text-white  text-lg p-5">
        <hr className="mb-5"/> 
...
<p>And the answers they seek, put to the test.</p>
    ...
    <hr className="mt-5"/>  
      <button
        className={`${BUTTON_COLOR} ${BUTTON_HOVER_COLOR} self-center w-1/2 p-3 mt-10 rounded-xl text-white transition cursor-pointer`}
        onClick={() => {
          handler();
        }}
      >
